...
const AkPhoneInput = ({ onChange, radius = 4, mode = "light", variant = "default", noShadow = false }) => {
    ...
    return (_jsx("div", {
        ref: containerRef, className: `ak-phone-input-main ${variant} ${mode}`, children: _jsxs("div", {
            className: "ak-phone-input-root", style: { borderRadius: `${radius}px` }, children: [_jsxs("div", { className: "ak-country-select-box", onClick: () => setIsOpen(!isOpen), style: { borderRadius: `${radius}px 0px 0px ${radius}px` }, children: [_jsx("img", { className: "country-flag", src: selectedCountry === null || selectedCountry === void 0 ? void 0 : selectedCountry.flag, alt: selectedCountry === null || selectedCountry === void 0 ? void 0 : selectedCountry.country_name }), _jsxs("div", { className: "ak-phone-input-icon", children: [" ", CheveronSvg, " "] })] }), _jsxs("div", { className: "ak-country-code-and-input", children: [_jsxs("span", { className: "country-code", children: [" ", selectedCountry === null || selectedCountry === void 0 ? void 0 : selectedCountry.label.split("(")[0], " "] }), _jsx("input", { type: "text", ref: inputRef, className: "phone-input", value: formattedValue, onKeyDown: _handleKeyDown, onChange: (e) => _handleChange(e), placeholder: mask !== null && mask !== void 0 ? mask : "0000" })] }), _jsx(Portal, {
                children: _jsxs("div", {
                    ref: dropdownRef, className: `ak-phone-input-dropdown ${isOpen && "open"} ${variant} ${mode} ${noShadow ? "no-sh" : ""}`, style: {
